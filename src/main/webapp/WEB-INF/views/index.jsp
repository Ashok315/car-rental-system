...
%>
  ...
  <body>
    ...
    <div class="hero-wrap" style="background-image: url('<c:url value="assets/images/lending_bg.jpg"/>');" data-stellar-background-ratio="0.5">
      <div class="overlay" style="opacity:0.3"></div>
      <div class="container">
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-center">
          	<div class="text mb-5">
	            <h1 class="mb-4 font-bold" style="font-size: 42px;font-weight:300">Now <span>It's easy for you</span> <span>rent a car</span></h1>
	            <p style="font-size: 18px;">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts</p>
	            <div class="align-items-center mt-4 mb-5 pb-4">
	            	<a href="${pageContext.request.contextPath}/Car">
		            	<button class="btn btn-primary py-2 px-4">Rent a car now</button>
	            	</a>
			          ...
			          <div class="col-md-12">
			            <div class="carousel-testimony owl-carousel ftco-owl">
							      ...
							      <c:forEach var="car" items="${cars }">
					    				...
					    				<div class="car-wrap ftco-animate shadow-lg">
					    					<div class="img d-flex align-items-center" style="background-image: url('<c:url value="/assets/images/car/${car.getId() }.jpg"/>');"></div>
					    					
					    					<div class="text text-center">
					    						
					    						<div class="price-wrap shadow-none d-flex justify-content-between align-items-center px-4 pb-0">
						    						  <h2 class="mb-0"><a href="Car/${car.getId()}">${car.getName() }</a><span>${car.getCompany() }</span></h2>
							    				      <p class="rate "><span class="d-inline text-primary">&#8377;</span>${car.getRate_per_day() }<span class="d-inline text-lowercase">/Day</span></p>
					    						</div>
					    						
												<div class="d-flex justify-content-center align-items-center mb-4 px-4" >
										    		<c:choose>
								    					<c:when test="${userId == 'YES' }">
								    						<a href="Car/${car.getId() }/Registration" class="btn btn-primary px-3 mr-3">Book now</a>
								    					</c:when>
								    					<c:when test="${userId == 'NO' }">
								    						<a class="btn btn-primary px-3 mr-3" onclick="alert('Please Login.')">Book now</a>
								    					</c:when>
								    				</c:choose>
					    						 	<a href="Car/${car.getId()}" class="btn btn-secondary px-3">Details</a>
					    						</div>
    ...
    <section class="ftco-section services-section img" style="background-image: url('<c:url value="assets/images/bg_2.jpg" />');">
