      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5 mb-5">
          	<p class="breadcrumbs mb-1"><span class="mr-2"><a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact <i class="ion-ios-arrow-forward"></i></span></p>
            <h2 class="mb-5 text-white">Contact us</h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
            ...
            <form action="${pageContext.request.contextPath}/Contact/Submit" class="bg-light p-5 contact-form" method="POST">
				<c:choose>
					...
					<c:otherwise>
						<div class="form-group">
		                	<input type="text" name="name" class="form-control" value="${userData.getFirstName() } ${userData.getLastName() }" placeholder="Your Name" required="required" readonly/>
		              	</div>
		              	<div class="form-group">
		                	<input type="email" name="email" class="form-control" value="${userData.getEmail() }" placeholder="Your Email" required="required" readonly/>
		              </div>
					</c:otherwise>
				</c:choose>
        ...
        <div class="row justify-content-center">
        	<div class="col-md-10">
        		<div id="ma" class="bg-white">
        			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8308.720705445072!2d72.65275654746709!3d23.25563748322482!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc5e83e23ad9c5127!2sGECG%20Boys%20Hostel!5e0!3m2!1sen!2sin!4v1582007284586!5m2!1sen!2sin" style="width:100%; height:400px;" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
        		</div>
        	</div>
        </div>
      </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="/CarRental/About" class="py-2 d-block">About</a></li>
