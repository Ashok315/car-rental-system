...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('<c:url value="/assets/images/bg_2.jpg"/>');" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs">
          		...
          		<span class="mr-2">Car Name <i class="ion-ios-arrow-forward"></i></span>
          	</p>
						    		...
						    		<div class="col-md-4">
						    			<ul class="features">
						    				...
						    				<c:choose>
						    					...
						    					<c:when test="${car.getAirconditions() == 'NO' }">
						    		...
						    		<div class="col-md-4">
						    			<ul class="features">
						    				...
						    				<c:choose>
						    					...
						    					<c:when test="${car.getBluetooth() == 'NO' }">
						    				...
						    				<c:choose>
						    					...
						    					<c:when test="${car.getRemote_central_locking() == 'NO' }">
						    				...
						    				<c:choose>
						    					...
						    					<c:when test="${car.getSeat_Belt() == 'NO' }">
						    		...
						    		<div class="col-md-4">
						    			<ul class="features">
						    				...
						    				<c:choose>
						    					...
						    					<c:when test="${car.getOnboard_computer() == 'NO' }">
						      ...
						      <div class="row">
							   		<div class="col-md-7">
							   			...
							   			<div class="review d-flex">
									   		<div class="user-img" style="background-image: url('<c:url value="../assets/images/person_1.jpg"/>')"></div>
									   		<div class="desc">
									   			<h4>
									   	...
									   	<div class="review d-flex">
									   		<div class="user-img" style="background-image: url('<c:url value="../assets/images/person_2.jpg"/>')"></div>
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Jacob Webb</span>
									   				<span class="text-right">14 March 2018</span>
									   	...
									   	<div class="review d-flex">
									   		<div class="user-img" style="background-image: url('<c:url value="../assets/images/person_3.jpg"/>')"></div>
									   		<div class="desc">
									   			<h4>
									   				<span class="text-left">Jacob Webb</span>
									   				<span class="text-right">14 March 2018</span>
