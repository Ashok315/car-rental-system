      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="${pageContext.request.contextPath}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Pricing <i class="ion-ios-arrow-forward"></i></span></p>
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="car-list">
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-1.jpg"/>');"></div></td>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-2.jpg"/>');"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-3.jpg"/>');"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-4.jpg"/>');"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-5.jpg"/>');"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('<c:url value="resources/images/car-6.jpg"/>');"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
