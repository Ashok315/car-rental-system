   	...
   	<div class="my-container row">
		...
		<div class="col-md-4">
			<div class="my-container" style="margin-top:25%; background-color:rgba(255,255,255,.2); border-radius:25px; box-shadow:5px 5px 20px #000" >
				<form:form modelAttribute="SignIn" action="${pageContext.request.contextPath}/SignIn/Process" method="POST">
					<div  style="width:90%; margin-left:5%;">
						<br>
						<h1 class="my-text-orange" style="margin:5%;">Sign In</h1>
						...
						<c:if test="${not empty param.Err}">
								<center style="color:red;">Please Enter the valid Email Or Password</center>
								<br>
						</c:if>
						
						<form:button class="my-orange my-button my-text-white" type="submit" name="submit" style="width:40%; margin-left:30%; border-radius:8px;">Sign In</form:button>
						<br><br>
						<center><a href="${pageContext.request.contextPath}/SignUp" class="my-text-white">Don't have an account? Register</a></center>
						<br>
					</div>
				</form:form>
			</div>
